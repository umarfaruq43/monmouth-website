...
import { PurchaseCol } from "./PurchaseCol";

const PurchaseTable = ({ purchase_details }) => {
    const router = useRouter();
    const columns = useMemo(() => PurchaseCol, []);
    const data = useMemo(() => purchase_details, []); // eslint-disable-line
    const {
        getTableProps,
        getTableBodyProps,
        headerGroups,
